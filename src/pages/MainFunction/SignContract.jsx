...
function SignContract() {
  ...
  const fetchInitialData = async () => {
    ...
    try {
      ...
      form.setFieldsValue({
        ...
        initialReading: 0 // Default value for initial water reading
      });
    } catch (error) {
  ...
  try {
    ...
    // Format dates to the required format and prepare data
    const contractData = {
      ...
      // Include the initial water reading value as a simple number
              ...
              <Card title="Thông tin hợp đồng" bordered={false}>
                ...
                <Row gutter={16}>
                  <Col span={8}>
                    <Form.Item
                      name="initialReading"
                      label="Chỉ số nước khởi đầu (m³)"
                      rules={[
                        { required: true, message: 'Vui lòng nhập chỉ số nước khởi đầu' },
                        { type: 'number', min: 0, message: 'Chỉ số nước phải là số dương' }
                      ]}
                    >
                      <InputNumber
                        style={{ width: '100%' }}
                  ...
                  <Col span={16}>
                    <div style={{ marginTop: 37 }}>
                      <Text type="secondary">
                        Chỉ số nước khởi đầu sẽ được sử dụng làm cơ sở cho việc tính toán hóa đơn trong tương lai.
                      </Text>
                    </div>
                  </Col>
                </Row>
